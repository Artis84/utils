...
curl -i -H "Accept: application/vnd.github+json" -H "Authorization: Bearer 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" https://api.github.com/user/repos -d "{\"name\":\"%workDir%\",\"description\":\"Project %workDir% repository 😮!\"}\"
